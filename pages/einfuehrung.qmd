...
- Mesh Distance Fields (Unreal Engine): Distanzfelder ermöglichen effiziente Berechnung von Ambient Occlusion, weichen Schatten und Global Illumination
- 3D-Rekonstruktion: TSDFs und moderne Neural-SDF-Verfahren rekonstruieren hochauflösende 3D-Modelle aus Tiefen- oder Bilddaten.
- Robotik: Distanzfelder unterstützen Kollisionsabfragen und Bewegungsplanung, indem sie den Abstand zu Hindernissen effizient bereitstellen.
- Schrift- und UI-Rendering: SDF- und MSDF-Fonts ermöglichen scharfe, beliebig skalierbare Schrift sowie Icons und UI-Elemente.

![Verwendung von Mesh Distance Fields in Unreal Engine 5](../assets/images/mesh-distance-field-example.png){#fig-csg width="70%"}
