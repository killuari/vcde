...
\subsection{SDF-Funktionen}\label{sdf-funktionen}
...
\subsection{Boolesche Funktionen}\label{boolesche-funktionen}
...
\subsection{Smooth Union: Idee}\label{smooth-union-idee}

\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{assets/diagrams/16-smooth-union-intuition.png}

\subsection{Smooth Union: Rechnung}\label{smooth-union-rechnung}

\includegraphics[width=1\linewidth,height=\textheight,keepaspectratio]{assets/diagrams/17-smooth-union-formula-flow.png}
